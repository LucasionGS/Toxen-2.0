...
function initialize() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        document.querySelector("select#songfolderValue").addEventListener("input", () => {
            settings.songFolder = document.querySelector("select#songfolderValue").value;
            settings.applySongFolderListToSelect();
...
function addCustomInputs() {
    ...
    let grouping = new toxenStyle_1.SelectBox.SelectBoxGroup([{
            "text": "No grouping",
            "value": 0,
            click() {
    ...
    let visualizerstyle = new toxenStyle_1.SelectBox.SelectBoxGroup([
        {
            text: "Bottom",
            value: 0,
            click() {
    ...
    // Visualizer Toggle
    let visualizer = new toxenStyle_1.SelectBox.SelectBox("Visualizer");
    ...
    // Storyboard Toggle
    let storyboard = new toxenStyle_1.SelectBox.SelectBox("Storyboard");
    ...
    // Video Toggle
    let video = new toxenStyle_1.SelectBox.SelectBox("Display Video");
    video.on("change", () => {
    ...
    let buttonactivationbyhovercontainer = new toxenStyle_1.SelectBox.SelectBox("Button Activation By Hover");
    ...
    document.getElementById("setsongdefaultcolor").appendChild(Toxen.generate.button({
        ...
        "click"() {
            let song = SongManager.getCurrentlyPlayingSong();
            if (song)
                song.details.visualizerColor = null;
            song.saveDetails();
    ...
    // Visualizer style radio buttons
    let thumbnails = new toxenStyle_1.SelectBox.SelectBoxGroup([
        {
            text: "No Images",
            value: 0,
            click() {
    ...
    let discordpresencecontainer = new toxenStyle_1.SelectBox.SelectBox("Discord Presence");
    ...
    let discordpresenceshowdetailscontainer = new toxenStyle_1.SelectBox.SelectBox("Discord Presence: Show Details");
    ...
    let freezevisualizercontainer = new toxenStyle_1.SelectBox.SelectBox("Freeze Visualizer");
